...
export const FW_TUNING_CONFIG = path.resolve(ROOT, "..", "src", "sensor_tuning", "FallDetectionConfig.ino");
export const FW_MAIN_CONFIG = path.resolve(ROOT, "..", "src", "main_firmware", "FallDetectionConfig.ino");
export const FW_TUNING_ENTRY = path.resolve(ROOT, "..", "src", "sensor_tuning", "sensor_tuning.ino");
export const FW_TUNING_RUNTIME_PROFILE = path.resolve(ROOT, "..", "src", "sensor_tuning", "RuntimeProfile.ino");
