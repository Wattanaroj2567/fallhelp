...
| `DEVICE_ONLINE`    | 🟢 อุปกรณ์เชื่อมต่อแล้ว   | อุปกรณ์ของ แม่ทองดี ออนไลน์แล้ว     | `{ type }`                   |
| `SYSTEM_UPDATE`    | 📢 อัปเดตระบบ             | มีเวอร์ชันใหม่พร้อมใช้งาน           | `{ type, version }`          |
