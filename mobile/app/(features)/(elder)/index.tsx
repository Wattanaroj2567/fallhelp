            ...
            <View className="rounded-[24px] overflow-hidden">
              ...
              <View className="flex-row border-b border-gray-100">
                ...
                <View className="flex-1 p-4">
                  ...
                  {age > 0 && (
                    <Text style={{ fontSize: 14 }} className="font-kanit text-gray-500 mt-1">
                      ({age} ปี)
                    </Text>
                  )}
                </View>
              ...
              <View className="p-4">
                ...
                <Text style={{ fontSize: 16 }} className="font-kanit text-gray-900">
                  {(() => {
                    const addressParts = [];
                    if (elder.houseNumber) addressParts.push(`บ้านเลขที่ ${elder.houseNumber}`);
                    if (elder.village) addressParts.push(`หมู่ที่ ${elder.village}`);
