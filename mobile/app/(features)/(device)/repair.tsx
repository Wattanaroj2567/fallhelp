...
export default function RepairScreen() {
  ...
  const handleDelete = (id: string, title: string) => {
    Alert.alert('ยืนยันการลบ', `ต้องการลบเรื่อง "${title}" หรือไม่?`, [
  ...
  const renderRightActions = (id: string, title: string) => {
    return (
      ...
      >
        ...
        <Text style={{ fontFamily: 'Kanit', fontSize: 12, color: '#FFFFFF', marginTop: 4 }}>
          ลบ
        </Text>
      </TouchableOpacity>
    );
            ...
            <View style={{ gap: 16 }}>
              {isLoadingHistory ? (
                ...
                <View style={{ alignItems: 'center', paddingVertical: 48, paddingHorizontal: 24 }}>
                  ...
                  >
                    {(historyError as Error)?.message || 'ไม่สามารถโหลดข้อมูลได้'}
                  </Text>
                  <TouchableOpacity
                ...
                <GestureHandlerRootView style={{ flex: 1 }}>
                  {historyItems?.map((item) => {
                    ...
                    const statusConfig: Record<
                      string,
                      { color: string; bg: string; text: string; barColor: string }
                    > = {
                      PENDING: {
                        color: '#B45309',
                        bg: '#FEF3C7',
                      ...
                      REVIEWED: {
                        color: '#1D4ED8',
                        bg: '#DBEAFE',
                        text: `รับเรื่องแล้ว จะติดต่อกลับ${userPhone}`,
                        barColor: '#3B82F6',
                      },
                      RESOLVED: {
                        color: '#15803D',
                        ...
                        >
                          <TouchableOpacity
                            onPress={() => {
                              ...
                              const fullMessage = item.message.replace(
                                /\[REPAIR REQUEST\] Topic: .*?\nDetails: /,
                                '',
                              );
                              Alert.alert(
                          ...
                          >
                            ...
                            <View style={{ flex: 1 }}>
                              ...
                              >
                                ...
                                <Text
                                  style={{ fontFamily: 'Kanit', fontSize: 11, color: '#9CA3AF' }}
                                >
