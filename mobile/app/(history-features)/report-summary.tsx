          ...
          {isLoading ? (
            ...
            <>
              ...
              <View className="bg-green-50 border-2 border-green-500 rounded-3xl p-6 mb-6">
                ...
                <View className="mb-6">
                  <View className="flex-row items-center mb-2">
                    <View className="w-10 h-10 rounded-full bg-green-100 items-center justify-center mr-3">
                      <Ionicons name="time" size={24} color="#16AD78" />
                    </View>
                ...
                <View className="mb-6">
                  ...
                  <Text style={{ fontSize: 32, fontWeight: '600' }} className="font-kanit text-orange-500 ml-13">
                    {summary.totalFallEvents} <Text className="font-kanit text-xl">ครั้ง</Text>
                  </Text>
                </View>
                  ...
                  <View className="ml-13">
                    <View className="flex-row items-center mb-2">
                      ...
                      <Text style={{ fontSize: 16 }} className="font-kanit text-gray-700">
                        ชีพจรสูง:{' '}
                        <Text className="font-kanit font-semibold text-red-500">{summary.heartRateAnomalies.high} ครั้ง</Text>
                      </Text>
                    </View>
                    <View className="flex-row items-center">
                      ...
                      <Text style={{ fontSize: 16 }} className="font-kanit text-gray-700">
                        ชีพจรต่ำ:{' '}
                        <Text className="font-kanit font-semibold text-blue-500">{summary.heartRateAnomalies.low} ครั้ง</Text>
                      </Text>
                    </View>
                  </View>
                </View>
              ...
              <TouchableOpacity
                ...
                className="bg-white border-2 border-green-500 rounded-2xl py-4 items-center"
              >
                <Text style={{ fontSize: 16, fontWeight: '600' }} className="font-kanit text-green-600">
