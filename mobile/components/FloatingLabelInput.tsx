...
export const FloatingLabelInput: React.FC<FloatingLabelInputProps> = ({
    ...
    const labelContainerStyle = useAnimatedStyle(() => ({
        top: interpolate(progress.value, [0, 1], [multiline ? 18 : LABEL_TOP_START, LABEL_TOP_END]),
        ...
        <View style={[{ marginBottom: 0, flexGrow: 0 }, containerStyle]}>
            ...
            >
                ...
                <Animated.View style={labelContainerStyle} pointerEvents="none">
                    <Animated.Text className="font-kanit" style={labelTextStyle as StyleProp<TextStyle>}>
                        {label}
                    </Animated.Text>
                </Animated.View>
                ...
                {/* Input Field */}
                <TextInput
                    className={`font-kanit rounded-2xl px-4 border ${error
                        ? 'border-red-500'
                        : isFocused
                            ? 'border-[#16AD78]'
                            : 'border-gray-300'
            ...
            {/* Error Message */}
            {error && (
                <Text style={{ fontFamily: 'Kanit', color: ERROR_COLOR, fontSize: 12, marginTop: 4, marginLeft: 4 }}>
                    {error}
                </Text>
            )}
        </View>
